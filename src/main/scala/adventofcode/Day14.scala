...
object Day14 extends AdventOfCodeBase[Int, Int]("day14.txt"):
  ...
  object PathParser extends JavaTokenParsers:
    ...
    def path: Parser[Path]               = repsep(coordinates, "->") ^^ { Path.apply }
