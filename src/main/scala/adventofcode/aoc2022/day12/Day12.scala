...
case class Day12(input: HeightMap) extends Problem[HeightMap, Int, Int](2022, 12, "Hill Climbing Algorithm") {
...
object Day12 {
  val instance: Day12 = Day12(parse(inputLines("2022/day12.txt")))
