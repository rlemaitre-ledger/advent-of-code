...
import adventofcode.aoc2022.day11.Day11
import adventofcode.aoc2022.day11.Day11.*
...
class Day11Test extends AoCTest {
  ...
  val round0: List[Monkey] = List(
    ...
    Monkey(
      ...
      operation = Operation.Increase(6),
      test = Test(19, 2, 0),
      inspections = 0
    ),
    Monkey(
  ...
  val round1: List[Monkey] = List(
    ...
    Monkey(number = 3, items = List.empty, operation = Operation.Increase(3), test = Test(17, 0, 1), inspections = 6)
  )
  val round2: List[Monkey] = List(
    ...
    Monkey(number = 3, items = List.empty, operation = Operation.Increase(3), test = Test(17, 0, 1), inspections = 10)
  )
  val round3: List[Monkey] = List(
    ...
    Monkey(number = 3, items = List.empty, operation = Operation.Increase(3), test = Test(17, 0, 1), inspections = 16)
  )
  ...
  test("increase operation") {
    assertEquals(Operation.Increase(1).modify(SimpleItem(10)), SimpleItem(11))
  }
  test("multiply operation") {
    assertEquals(Operation.Multiply(3).modify(SimpleItem(10)), SimpleItem(30))
  }
  test("square operation") {
    assertEquals(Operation.Square.modify(SimpleItem(10)), SimpleItem(100))
  }
  test("play round 1") {
    assertEquals(
